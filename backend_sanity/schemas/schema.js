...
export default createSchema({
  ...
  types: schemaTypes.concat([testimonialSchema, aboutSchema, brandsSchema, experienceSchema, skillsSchema, contactSchema, workExperienceSchema, worksSchema, educationSchema])
});
